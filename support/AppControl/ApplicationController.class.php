...
class ApplicationController implements AppControllerInterface {
	...
	public function remove_disallowed_params( &$which_array = null ) {
		...
		try {
			...
			if ( $which_array === null ) {
				...
				if ( isset($_GET) ) $this->remove_disallowed_params($_GET);
				if ( isset($_POST) ) $this->remove_disallowed_params($_POST);
				if ( isset($_SESSION) ) $this->remove_disallowed_params($_SESSION);
				if ( isset($_COOKIE) ) $this->remove_disallowed_params($_COOKIE);
	...
	*/
	...
	public function _set_active_user ( $user ) {

		$this->_Active_user_obj = $user;
	}
